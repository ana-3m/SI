...
if (isset($_POST['toggle_visibility'])) {
    ...
    echo "<script>alert('Car visibility updated.'); window.location.href = 'teste.php';</script>";
}
...
if (isset($_POST['delete_car'])) {
    ...
    echo "<script>alert('Car deleted successfully.'); window.location.href = 'teste.php';</script>";
}
...
if (isset($_POST['edit_preco'])) {
    ...
    if (is_numeric($new_preco) && $new_preco >= 0) {
        ...
        echo "<script>alert('Car price updated successfully.'); window.location.href = 'teste.php';</script>";
    } else {
        echo "<script>alert('Invalid price. Please enter a valid number.'); window.location.href = 'teste.php';</script>";
    }
}
